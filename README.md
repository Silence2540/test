...
### 2019112369吴可涵
  眨眼一个学期过去了，通过对代码与实物这门课的学习，我收货颇丰。以前只是学习一些理论性的知识，但是这门课让我们能真正动手去实现一些我们的创意和想法。提高了我的动手能力，也让我对书本上的知识有了更加深入的理解。
  
  首先我们学习了运用CAD软件设计模型。设计好模型后，我们又分别用激光切割技术和3D打印技术将我们用CAD软件建模好的模型切割或打印成实体。看着自己一步一步做出的实物，我的内心充实而满足。
  
  我们还学习了如何使用arduino，通过对arduino有了一定的认识后，我们小组通过arduino编程，完成了超声波雷达扫描的实现的软件部分，之后，我们又将电脑与arduino板、超声波测距仪，以及蜂鸣器等连接，完成了从代码到实物的实现。我们还利用processing，将超声波扫描结果实时地显示在电脑上。
  
  在从代码到实物的过程中，我们还是以团队合作的方式进行，让我结实了更多的朋友，也让我变得更加善于与人交流，更加明白了合作的重要性，也更加懂得了如何与他人合作。
### 2019112270周欣成
从代码到实物这门课，让我收获良多。在这门课的学习过程中，我首先了解了freeCAD软件的使用，即“代码”，或者说软件部分。然后紧接着我又学会了通过3D打印机和激光切割技术，将我在freeCAD中所设计的模型打印、切割出来，也就是将我在软件中的设计变成真实地存在着的“实物”。当我亲手触摸到3D打印出来的零件，仔细地观察它，感受它的质感，我感到无比兴奋。
如果说对于freeCAD建模、3D打印、激光切割的学习是前半学期的演练，那么后半学期，我们小组则是一起利用arduino，真枪实弹地完成了一个更加复杂，同时也更加有意义的项目——超声波雷达扫描。
在完成这个项目的过程中，我们首先参考了网上的设计代码，然后着手开始编程。进行“代码”的编写时，我深刻体会到了arduino的功能的强大。有的我们以为很难实现的功能，其实调用一个现成的库就轻松解决了。之后，我们又将电脑与arduino板、超声波测距仪，以及蜂鸣器等连接，完成了从代码到实物的实现。此外，我们还学习了processing的使用，从而可以将超声波扫描结果实时地显示在电脑上。
最后，在克服了一系列困难之后，我们终于成功地完成了该项目。看着这个从代码到实物都完全由我们自己设计的造物，顺利地运行、各项功能正常，我们组的每一个人心中都充满了成就感。
