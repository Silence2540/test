//Because we don't konw how do Processing display Chinese characters,
//we annotate our codes in English.
...
void setup() {
    ...
    size(1755, 988);
    smooth();
    //build the port detecter(like?)
    myPort = new Serial(this, "COM6", 9600);
    myPort.clear();
    myPort.bufferUntil('\n');
    orcFont = loadFont("OCRAExtended-48.vlw");
}
//like main function, run forever
void draw() 
{
    fill(98, 245, 31);
    textFont(orcFont);
...
//the function to get the data of the port
...
void DrawObject() 
{
    ...
    //if the distance is in the range of the radar
